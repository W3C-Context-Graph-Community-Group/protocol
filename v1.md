...
key-value rows. Each row names one constraint:
  ...
  ---------------------------------------|--------------------------------
  type                                   | object
  required                               | [claim-id, claim-source,
                                         |  timestamp, key, value]
...
itself. A natural second dataset is the dark-fraction formula —
Jacek Kowalski's construction from the Liquid Hypergraphs paper that
this protocol operationalizes. Its URL:
...
#facet/context — the formula's provenance and history:
  ...
  timestamp                | category         | key       | value
  -------------------------|------------------|-----------|---------------------
  2026-04-19T00:00:00.000Z | formula-declared | source    | Kowalski 2026, Liquid Hypergraphs
...
Jacek's recursion and trajectory fingerprint formulas from his
Wednesday-napkin math are natural second and third additions. The
protocol ships with one formula in core at v1; the library is
expected to grow.
